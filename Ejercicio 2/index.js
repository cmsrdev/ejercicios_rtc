...
const sum = (a, b) => a + b;
console.log(sum(toy1.price, toy2.price));
...
// let result = sum(toy1.price, toy2.price); // comento esta linea porque hace conflicto con el resultado 3 al tener mismo nombre la variable result
console.log(result);
